...
class Promocodes
{
    ...
    public function createDisposable(
        ...
        return $this->create($amount, $reward, $data, $expires_in, $quantity, $month, true);
    }
     ...
     */
    public function apply($code, $user, $plan)
    {
        if (!auth()->check()) {
     ...
     * @throws UnauthenticatedException
     */
    public function redeem($code, $user, $plan)
    {
        return $this->apply($code, $user, $plan);
    }
